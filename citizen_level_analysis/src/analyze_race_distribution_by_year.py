...
ax.set_title('Use of Force Incidents by Citizen Race — Louisiana State Police\n'
...
plt.tight_layout()
plt.savefig('citizen_level_analysis/output/citizen_race_by_year.png', dpi=300, bbox_inches='tight')
plt.show()

print("\nChart saved to 'citizen_level_analysis/output/citizen_race_by_year.png'")
