...
uof_df = pd.read_csv('citizen_level_analysis/input/uof_cit_louisiana_state_pd_2022_2024.csv')
...
census_df = pd.read_csv('citizen_level_analysis/input/lsp_troop_demographics_16plus.csv')
...
print("=" * 85)
print("POPULATION-NORMALIZED USE OF FORCE ANALYSIS")
...
ax.set_title('Use of Force Incidents vs Population Demographics\nLouisiana State Police (2022-2024)',
...
note_text = f"Note: Unknown has no population comparison. Total incidents: {total_uof:,}"
ax.text(0.5, -0.25, note_text, transform=ax.transAxes,
        ha='center', fontsize=9, style='italic')

plt.tight_layout()
plt.savefig('citizen_level_analysis/output/citizen_race_population_normalized.png', dpi=300, bbox_inches='tight')
