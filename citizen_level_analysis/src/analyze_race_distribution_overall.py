...
# Read the CSV file
df = pd.read_csv('citizen_level_analysis/input/uof_cit_louisiana_state_pd_2022_2024.csv')
...
ax.set_title('Use of Force Incidents by Citizen Race\nLouisiana State Police (2022-2024)',
...
plt.tight_layout()
plt.savefig('citizen_level_analysis/output/citizen_race_distribution.png', dpi=300, bbox_inches='tight')
