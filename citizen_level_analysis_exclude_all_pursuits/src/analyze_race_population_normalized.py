...
print("=" * 85)
print("POPULATION-NORMALIZED USE OF FORCE ANALYSIS (ALL PURSUIT EXCLUDED)")
...
print("- ALL INCIDENTS CONTAINING PURSUIT HAVE BEEN EXCLUDED FROM THIS ANALYSIS")
print("=" * 85)
...
ax.set_title('Use of Force Incidents vs Population Demographics (All Pursuit Excluded)\nLouisiana State Police (2022-2024)',
...
note_text = f"Note: Unknown has no population comparison. Total incidents: {total_uof:,} (All Pursuit excluded)"
ax.text(0.5, -0.25, note_text, transform=ax.transAxes,
        ha='center', fontsize=9, style='italic')

plt.tight_layout()
plt.savefig('citizen_level_analysis_exclude_all_pursuits/output/citizen_race_population_normalized.png', dpi=300, bbox_inches='tight')
