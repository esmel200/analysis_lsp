...
ax.set_title('Disparity Ratio by Troop and Race (Pursuit Excluded)\nUoF % ÷ Population % — Louisiana State Police 2022-2024',
...
plt.tight_layout()
plt.savefig('citizen_level_analysis_no_pursuit/output/disparity_table.png', dpi=300, bbox_inches='tight')
plt.show()

print("\nChart saved to 'citizen_level_analysis_no_pursuit/output/disparity_table.png'")
